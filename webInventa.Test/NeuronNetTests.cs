...
namespace webInventa.Test
{
    ...
    public class NeuronNetTests
    {
        ...
        public void Test2_1()
        {
            //Ручной счет, проверка коректировки весов с нормализацией
            #region init
        ...
        //[Test]
        //public void Test3()
        //{//проверка результата после 1000 итераций, без нормализции
        //    #region init
        //    var viborka = new List<ViborkaListItem>();
        //    viborka.Add(new ViborkaListItem
        //    {
        ...
        //[Test]
        //public void Test4()
        //{//проверка результата после 1000 итераций, с нормализцией
        //    #region init
